...
clear;clc;
dbstop if error
smrFile = 'E:\FP\data\smcs38\smcs38data0620\smcs38data062019\smcs38data062019.smr';

%% Step 1 Allign Data

% Read Bonsai csv Files
dataTable = readtable('E:\FP\data\smcs38\smcs38data0620\smcs38data062019\smcs38data062019.csv');
...
rawdata = importSpike(smrFile,chanindsAll(14));
